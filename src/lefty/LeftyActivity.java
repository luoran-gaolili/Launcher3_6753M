...
//import lefty.settings.LeftySettingsActivity;
...
//    private final int READ_PHONE_PERMISSOIN_INTENT = 200;
//    ApiTask mTask = null;
//
...
//        return getSharedPreferences().getBoolean(CommonsUtils.SHARED_PREF_ALLOW_LEFTY_KEY, true);
//    }
//
...
//    }
//
//    private void setUpLftySettings() {
//        View settingsButton = findViewById(R.id.l_settings_button);
//        settingsButton.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View arg0) {
//                startActivity(new Intent(LeftyActivity.this, LeftySettingsActivity.class));
//            }
//        });
...
//                String statusForPermission = preferences.getString("checkForIdPermission", "0");
//                if (statusForPermission.equalsIgnoreCase("1")) {
//                    callingShow();
//                } else {
...
//                return;
//            }
//            case READ_PHONE_PERMISSOIN_INTENT: {
//                SharedPreferences.Editor editor = getSharedPreferences().edit();
//                editor.putString("checkForIdPermission", "1");
//                editor.commit();
//                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
...
//                    editor.commit();
//                } else {
//                    editor.putString("deviceId", CommonsUtils.getSecureDeviceId(this));
//                    editor.commit();
//                }
//                callingShow();
//                return;
...
//        ImageLoader.getInstance().displayImage("drawable://" + R.drawable.lefty_native_splash, mNativeImageView);
//        ImageLoader.getInstance().displayImage("drawable://" + R.drawable.lefty_splash, mSplashImageView);
//
//    }
//
//    @Override
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(response) && CommonsUtils.isJSONValid(response)) {
                    Gson gson = new Gson();
                    /*Example example = gson.fromJson(response, Example.class);
                    saveAdvDataInPref(example.getData().getAdvbanner().get(0));*/
                    Example example = gson.fromJson(response, Example.class);
                    saveAdvDataInPref(example.getData().getAdvbanner());
                }
            } catch (Exception e) {
