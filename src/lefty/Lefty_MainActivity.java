...
//            saveAdvDataInPref(mCompleteData.getData().getAdvbanner().get(0));
//            saveNumOfSwipeInPref();
    ...
    private void init(View mMainView) {
        ...
        mTwitterHeader.setVisibility(View.GONE);
        ...
        mTwitterTrendingNewsHeader.setVisibility(View.GONE);
        ...
        mScrollView = (ScrollView) mMainView.findViewById(R.id.mScrollveiw);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        Log.e("scroll", "downevent");

                        break;

                    case MotionEvent.ACTION_UP:
                        Log.e("scroll", "upevent");
                        mSearchYahooEdt.clearFocus();
...
//                            }else{
//                                Toast.makeText(getActivity(), "com.til.timesnews", Toast.LENGTH_SHORT).show();
//                            }
...
//    }
    ...
    void openTOI(String deepLinkURL) {
        ...
        if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
            ...
            //openBrowser(mLeftyPref.getString(CommonsUtils.SHARED_PREF_NEWSPOINT_KEY,""));
    ...
    private void loadTweets(List<Tweet> tweet) {
        ...
        TweetUtils.loadTweets(ids, new Callback<List<Tweet>>() {
            ...
            public void success(Result<List<Tweet>> result) {
                ...
                mTwitterHeader.setVisibility(View.VISIBLE);
    ...
    private void loadTrendingTweets(List<Tweet> tweet) {
        ...
        TweetUtils.loadTweets(ids, new Callback<List<Tweet>>() {
            ...
            public void success(Result<List<Tweet>> result) {
                ...
                mTwitterTrendingNewsHeader.setVisibility(View.VISIBLE);
                for (Tweet tweet : result.data) {
                    CompactTweetView mTweetView = new CompactTweetView(getActivity(), tweet);
